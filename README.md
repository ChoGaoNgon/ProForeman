...
- Người dùng không có quyền quản lý tài chính sẽ được chuyển hướng mặc định vào màn hình **Báo cáo** khi đăng nhập để tập trung vào việc cập nhật nhật ký hiện trường.
